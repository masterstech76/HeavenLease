...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            // User no longer exists (e.g. DB was wiped), is deactivated, or any other
            // authentication failure while loading the principal — treat the token as
            // invalid and continue unauthenticated so the caller gets a clean 401
            // (and the frontend auto-logs-out) instead of an uncaught 500.
        }
