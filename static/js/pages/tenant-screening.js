/* ============================================================
 * HeavenLease — tenant-screening page module
 * Extracted from tenant-screening.html (2 inline blocks).
 * Removes all inline <script> from the page per project rule.
 * ============================================================ */

function clearHelpMessage() {
            var msg = document.getElementById('helpMessage');
            if (msg) msg.value = '';
            ...
            if (note) {
                note.textContent = 'Messages go to our support team by email. Prefer email? Write to support@heavenlease.in';
            }
        }
